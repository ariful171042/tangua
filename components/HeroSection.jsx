...
const HeroSection = () => {
  return (
    <div className=" w-[100vw] sm:h-[90vh] h-[70vh] relative overflow-hidden">
      ...
      <div className="absolute w-full sm:w-auto md:w-full p-5 md:p-10 z-10  top-1/2 mt-8 left-1/2 -translate-x-1/2 -translate-y-1/2 flex flex-col gap-2 justify-center items-center text-white">
        <h1 className="sm:text-4xl text-3xl font-medium md:text-6xl">
          টাঙ্গুয়ার ভাসমান বাড়ি
        </h1>
        <p className="text-center text-xl sm:text-sm md:text-3xl md:leading-snug">
        ...
        <button className="bg-yellow-400 text-gray-900 p-2 md:px-5 rounded-md">
          আরও জানুন
        </button>
      </div>
    </div>
