...
const Gallery = ()=> {
  ...
  return (
    <div className=' container mx-auto mt-10'>
      <h2 className=" mb-5 text-4xl font-medium">টাঙ্গুয়ার হাওর ভ্রমণ ফটোগ্যালারি</h2>

      <SlideshowLightbox lightboxIdentifier="lightbox" framework="next" images={images}  showThumbnails={true} theme="lightbox" >
